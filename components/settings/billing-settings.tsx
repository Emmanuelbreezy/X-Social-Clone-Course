...
const BillingSettings = async () => {
  ...
  return (
    <div className="w-full px-4 pt-5">
      ...
      <div className="lg:col-span-2 flex justify-start lg:justify-center mt-4 gap-2 ">
        {plan && plan === PLAN_TYPE.FREE ? (
          ...
          <div className="relative w-full max-w-[350px] h-[220px]">
            <Image
              ...
              height={400}
              alt="image"
              className="w-full h-full brightness(0) saturate(100%) hue-rotate(190deg) brightness(1.2)"
            />
            <div className="absolute top-0 rounded-lg left-0 w-full h-full flex items-center justify-center inset-0 bg-black/20">
              <SubscriptionButton />
            </div>
          </div>
        ) : null}
